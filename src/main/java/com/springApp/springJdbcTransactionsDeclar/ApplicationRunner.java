package com.springApp.springJdbcTransactionsDeclar;

import com.springApp.springJdbcTransactionsDeclar.dao.jdbc.JdbcTemplateDeveloperDaoImpl;
import com.springApp.springJdbcTransactionsDeclar.dao.jdbc.JdbcTemplateProjectDaoImpl;
...
public class ApplicationRunner {
    public static void main(String[] args) {
        ...
        JdbcTemplateDeveloperDaoImpl jdbcTemplateDeveloperDao =
                (JdbcTemplateDeveloperDaoImpl) context.getBean("jdbcTemplateDeveloperDao", JdbcTemplateDeveloperDaoImpl.class);
